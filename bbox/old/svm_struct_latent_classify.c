...
void read_input_parameters(int argc, char **argv, char *testfile, char *modelfile, char *labelfile, char *latentfile, STRUCT_LEARN_PARM *sparm);
...
int main(int argc, char* argv[]) {
  ...
  read_input_parameters(argc,argv,testfile,modelfile,labelfile,latentfile,&sparm);
